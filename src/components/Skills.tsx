      ...
      <div className="flex gap-7 sm:container sm:mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 items-center w-1/2 h-fit p-5 my-auto bg-secondary rounded-xl">
          {skillsList.map((skill, i) => {
            return (
              <div className="w-fit bg-terciary rounded-lg border border-zinc-900 transition-colors overflow-hidden hover:border-primary">
                {
                  <Image
                    src={skill.image}
                    alt={skill.title}
        ...
        <div className="w-1/2 text-xl">
          ...
          <p className="hidden" id="bootstrap">
