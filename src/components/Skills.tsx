    ...
    >
      ...
      <div className="flex flex-col items-center gap-7 container mx-auto px-5 sm:flex-row">
        ...
        <div className="flex items-center flex-1 text-lg">
          ...
          <p className="content hidden text-justify" id="html">
          ...
          <p className="content hidden text-justify" id="css">
          ...
          <p className="content hidden text-justify" id="javascript">
          ...
          <p className="content hidden text-justify" id="react">
          ...
          <p className="content hidden text-justify" id="sass">
          ...
          <p className="content hidden text-justify" id="bootstrap">
          ...
          <p className="content hidden text-justify" id="git">
          ...
          <p className="content hidden text-justify" id="typescript">
          ...
          <p className="content hidden text-justify" id="reactNative">
          ...
          <p className="content hidden text-justify" id="nextJs">
          ...
          <p className="content hidden text-justify" id="node">
          ...
          <p className="content hidden text-justify" id="tailwind">
