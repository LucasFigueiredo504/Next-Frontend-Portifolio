export function Skills() {
  return (
    <section className="flex-col w-full py-32 border-b-2 border-primary bg-gradient-to-r from-terciary via-terciary to-secondary">
      <h1 className="text-center mb-28 text-5xl font-bold">Habilidades</h1>
      <div className="flex gap-7 max-w-7xl mx-auto">
        <div className="flex flex-wrap gap-5 items-center w-1/2 bg-secondary p-5 rounded-xl">
          <div className="w-32 h-32 bg-terciary rounded-md border border-zinc-900 hover:border-primary"></div>
          <div className="w-32 h-32 bg-terciary rounded-md border border-zinc-900 hover:border-primary"></div>
          <div className="w-32 h-32 bg-terciary rounded-md border border-zinc-900 hover:border-primary"></div>
          <div className="w-32 h-32 bg-terciary rounded-md border border-zinc-900 hover:border-primary"></div>
          <div className="w-32 h-32 bg-terciary rounded-md border border-zinc-900 hover:border-primary"></div>
